...
def listaCuota(request):
    ...
    total_importe = Cuota.objects.aggregate(Sum('importe'))['importe__sum'] or 0  # Sumar el importe
    return render(request, "crudCuotas/listado.html", {'cuotas': cuotas, 'total_importe': total_importe})
